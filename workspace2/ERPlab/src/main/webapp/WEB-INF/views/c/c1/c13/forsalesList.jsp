         ...
         <c:choose>
            <c:when test="${map != null }">
               <form action="${pageContext.request.contextPath }/internationsales/export/update" method="POST" id="update">
                  ...
                  <div>
                     <label>CINO</label>
                     <input type="text" name="forsales_cino" id="forsales_cino" value="${map.forsales_cino }">
                  </div>
                  <div>
                     <label>BLNO </label>
                     <input type="text" name="forsales_blno" id="forsales_blno" value="${map.forsales_blno }">
                  </div>
            ...
            <form action="${pageContext.request.contextPath }/internationalsales/export/insert" method="POST" id="create">
                  ...
                  <div>
                     <label>CINO </label>
                     <input type="text" name="forsales_cino" id="forsales_cino">
                  </div>
                  <div>
                     <label>BLNO </label>
                     <input type="text" name="forsales_blno" id="forsales_blno">
                  </div>
