...
<div class="notosanskr">
    ...
    <div>
        ...
        <form action="${pageContext.request.contextPath}/d/d3/d33/update">
        ...
        <div>
           ...
           <input type="button" value="delete" onclick="location.href='${pageContext.request.contextPath}/d/d3/d33/delete?inventory_no=${inmap.inventory_no }&comcode_code=${comcode_code }'">
			</c:if>
           <input type="button" value="list" onclick="location.href='${pageContext.request.contextPath}/d/d3/d33/inputInventory?comcode_code=${comcode_code }'">
        </div>
        </form>
        </c:if>
	</div>
    ...
    <div>
        <c:if test="${inmap == null }">
        <form action="${pageContext.request.contextPath}/d/d3/d33/createInventory">
        	<input type="hidden" name="comcode_code" id="comcode_code" value="${comcode_code }">
...
function deleteGoods(ino, pno){
	...
	var url = "${pageContext.request.contextPath }/d/d3/d33/deleteGoods";
...
function goodsList(code, h){
	let openWin = window.open("${pageContext.request.contextPath}/d/d3/d33/goodsList?comcode_code="+code+"&i="+h, "_blank", "scrollbars=yes, top=150, left=300, width=1000, height=500");
}
function goodsList1(code, h){
	let openWin = window.open("${pageContext.request.contextPath}/d/d3/d33/goodsList1?comcode_code="+code+"&i="+h, "_blank", "scrollbars=yes, top=150, left=300, width=1000, height=500");
}

function employee(code){
	let openWin = window.open("${pageContext.request.contextPath}/d/d3/d33/employee?comcode_code="+code, "_blank", "scrollbars=yes, top=150, left=300, width=500, height=500");
}

function coList(code){
	let openWin = window.open("${pageContext.request.contextPath}/d/d3/d33/coList?comcode_code="+code, "_blank", "scrollbars=yes, top=150, left=300, width=1000, height=500");
}
