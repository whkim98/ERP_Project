...
<div class="notosanskr">
    ...
    <div>
        ...
        <form action="${pageContext.request.contextPath}/d/d2/d22/update">
        ...
        <table>
        	...
        	<tr>
        		<th>구매코드</th>
        		<td><input type="text" name="purchase_code" id="purchase_code" value="${inmap.purchase_code }" readonly="readonly" class="required" maxlength="30"></td>
        		<th>매입 일자</th>
        	...
        	<tr>
        		<th>매입 내용</th>
        		<td colspan="3" rowspan="2"><input type="text" name="purchase_content" id="purchase_content" value="${inmap.purchase_content }" maxlength="500"></td>
        		<th>대표자</th>
    ...
    <div>
        ...
        <form action="${pageContext.request.contextPath}/d/d2/d22/createPurchase">
        	...
        	<tr>
        		<th>구매코드</th>
        		<td>
        			<input type="text" name="purchase_code" id="purchase_code" onblur="code(this.value)" class="required" maxlength="30">
        	...
        	<tr>
        		...
        		<td colspan="3" rowspan="2"><input type="text" name="purchase_content" id="purchase_content" maxlength="500"></td>
        		<th>대표자</th>
...
function employee(code){
	let openWin = window.open("${pageContext.request.contextPath}/d/d2/d22/employee?comcode_code="+code, "_blank", "scrollbars=yes, top=150, left=300, width=500, height=500");
}
...
function deleteGoods(ono, odno, price, tax, total, code, qty, glno){
	...
	var url = "${pageContext.request.contextPath }/d/d2/d22/deleteGoods";
...
function goodsList(code, h){
	...
	let openWin = window.open("${pageContext.request.contextPath}/d/d2/d22/goodsList?comcode_code="+code+"&i="+h+"&client_name="+cv, "_blank", "scrollbars=yes, top=150, left=300, width=1000, height=500");
}
function goodsList1(code, h){
	...
	let openWin = window.open("${pageContext.request.contextPath}/d/d2/d22/goodsList1?comcode_code="+code+"&i="+h+"&client_name="+cv, "_blank", "scrollbars=yes, top=150, left=300, width=1000, height=500");
}
function searcht(){
...
function code(v){
	var url = "${pageContext.request.contextPath }/d/d2/d22/getPurchaseCode";
