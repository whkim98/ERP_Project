...
<%@include file="/WEB-INF/views/dhlayout/header.jsp" %>
	...
	<!-- 리스트 클릭 시 url 데이터 숨기기 위한 form태그 -->	
			<form action="${pageContext.request.contextPath }/a/a4/a42/updateForm" id="content" method="post">
		...
		<div id="add" class="divform3">
			<c:choose>
				<c:when test="${inmap != null }">
					<form action="${pageContext.request.contextPath }/a/a4/a42/update" method="POST" id="update">
						<input type="hidden" name="comcode_code" value="${comcode_code }">
				...
				<c:otherwise>
					<form action="${pageContext.request.contextPath }/a/a4/a42/createLease" method="POST" id="create">
						<input type="hidden" name="comcode_code" value="${comcode_code }">
