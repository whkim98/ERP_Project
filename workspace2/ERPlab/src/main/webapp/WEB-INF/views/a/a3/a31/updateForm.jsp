...
<div align="center">
	...
	<input type="hidden" name="projectkind_no" id="projectkind_no" value="${map.projectkind_no}">
		...
		<table>
			...
			<tr>
				<td>프로젝트 종류 :</td>
				<td><input type="text" name="projectkind_name" id="projectkind_name" value="${map.projectkind_name }" onkeypress="kind(event, this.value)">
			...
			<tr>
				<td>프로젝트 담당자 :</td>
				<td><input type="text" name="employee1_name" id="employee1_name" value="${map.employee1_name }" onkeypress="searchemp(event, '${comcode_code}')">
			...
			<tr>
				<td>프로젝트 담당팀 :</td>
				<td><input type="text" name="team_name" id="team_name" value="${map.team_name }" onkeypress="team(event, this.value)">
