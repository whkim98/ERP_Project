...
function setParentText(h, lot, code, barcode, name, gkno, cprice, cno1, cno2, unit, size, pcg, ea, cname1, cname2, sname, kname, qty){
	...
	opener.document.getElementById("crlist1["+h+"].goodslot_no").value = pcg;
	...
	opener.document.getElementById("crlist1["+h+"].invenlot_qty").value = '';
	opener.document.getElementById("crlist1["+h+"].invenlot_date").value = '';
	opener.document.getElementById("crlist1["+h+"].invenlot_recode").value = '';
	window.close();
}
