...
<script type="text/javascript">
	function setParentText(h, no, code, barcode, name, unit, size, ea, cname1, cname2, sname, kname, total){
    	...
    	opener.document.getElementById("iclist["+h+"].goodslot_no").value = no;
    	opener.document.getElementById("crlist["+h+"].goodslot_total").value = total;
    	...
    	opener.document.getElementById("iclist["+h+"].invenconnect_qty").value = '';
    	opener.document.getElementById("iclist["+h+"].invenconnect_availableqty").value = '';
    	opener.document.getElementById("iclist["+h+"].invenconnect_date").value = '';
    	window.close();
    }
