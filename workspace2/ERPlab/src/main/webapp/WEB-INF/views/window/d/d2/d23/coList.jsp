...
<div>
	...
	<table id="procode">
		...
		<c:forEach var="vo" items="${list }">
				<tr onclick="setParentText(${vo.company_no },'${vo.company_name}','${vo.company_representative}', '${vo.company_addr1 }', '${vo.company_addr2 }', '${vo.company_registeredno }', '${vo.company_businesstype }', '${vo.company_use }', '${vo.company_opendate }', '${vo.comptype_code }')">
...
function setParentText(no, name, rep, addr1, addr2, rno, btype, use, odate, code){
	...
	opener.document.getElementById("company_businesstype").value = btype;
	...
	opener.document.getElementById("company_opendate").value = odate;
	...
	function bnajax(v, code){
		...
		var url = "${pageContext.request.contextPath}/d/d2/d23/coListAjax";
		...
		if(xhr.readyState==4 && xhr.status==200) {	
			...
			if(data != "")
				...
				data2.forEach(function(map){
					...
					newTr.setAttribute("onclick", "setParentText("+map.company_no+", '"+map.company_name+"', '"+map.company_representative+"', '"+map.company_addr1+"', '"+map.company_addr2+"', '"+map.company_registeredno+"', '"+map.company_businesstype+"', '"+map.company_use+"', '"+map.company_opendate+"', '"+map.comptype_code+"')");
