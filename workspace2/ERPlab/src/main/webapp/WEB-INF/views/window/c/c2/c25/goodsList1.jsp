...
<script type="text/javascript">
	function setParentText(h, no, gno, code, barcode, name, unit, size, ea, cname1, cname2, sname, kname){
    	...
    	opener.document.getElementById("sglist["+h+"].goodslot_no").value = no;
    	opener.document.getElementById("sglist["+h+"].goods_no").value = gno;
    	...
    	opener.document.getElementById("sglist["+h+"].salesgoods_qty").value = '';
    	opener.document.getElementById("sglist["+h+"].salesgoods_price").value = '';
    	opener.document.getElementById("sglist["+h+"].salesgoods_tax").value = '';
    	opener.document.getElementById("sglist["+h+"].salesgoods_total").value = '';
    	window.close();
    }
