...
<script type="text/javascript">
	function setParentText(h, gno, no, code, barcode, name, unit, size, ea, cname1, cname2, sname, kname){
    	...
    	opener.document.getElementById("plist1["+h+"].goodslot_no").value = no;
    	...
    	opener.document.getElementById("plist1["+h+"].purchaseconnect_number").value = '';
    	opener.document.getElementById("plist1["+h+"].purchaseconnect_price").value = '';
    	opener.document.getElementById("plist1["+h+"].purchaseconnect_tax").value = '';
    	opener.document.getElementById("plist1["+h+"].purchaseconnect_total").value = '';
    	window.close();
    }
