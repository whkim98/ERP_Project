...
<script type="text/javascript">
	function setParentText(h, code, barcode, name, gkno, cprice, dcp, cno1, cno2, unit, spec, size, pcg, ea, cname1, cname2, sname, kname){
		...
		opener.document.getElementById("crlist["+h+"].goodslot_no").value = pcg;
		...
		opener.document.getElementById("crlist["+h+"].invenlot_qty").value = '';
		opener.document.getElementById("crlist["+h+"].invenlot_date").value = '';
		opener.document.getElementById("crlist["+h+"].invenlot_recode").value = '';
    	window.close();
    }
