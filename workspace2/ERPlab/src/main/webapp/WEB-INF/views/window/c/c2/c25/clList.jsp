...
<div>
	...
	<table id="procode">
		...
		<c:forEach var="vo" items="${list }">
				<tr onclick="setParentText(${vo.client_no }, '${vo.client_name}', '${vo.client_registeredno }', '${vo.client_representative }', '${vo.client_directno }')">
...
<script type="text/javascript">
	function setParentText(no, name, register, representative, directno){
	...
	function bnajax(v, code){
		...
		var url = "${pageContext.request.contextPath}/c/c2/c25/clListAjax";
		...
		if(xhr.readyState==4 && xhr.status==200) {	
			...
			if(data != ""){
				...
				data2.forEach(function(map){
					...
					newTr.setAttribute("onclick", "setParentText("+map.client_no+",'"+map.client_name+"','"+map.client_registeredno+"','"+map.client_representative+"','"+map.client_directno+"')");
