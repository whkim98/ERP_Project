...
<script type="text/javascript">
	...
	function bnajax(v, code){
		...
		var url = "${pageContext.request.contextPath}/a/a3/a32/clListAjax";
		...
		if(xhr.readyState==4 && xhr.status==200) {	
			...
			if(data != ""){
				...
				data2.forEach(function(map){
					...
					newTr.setAttribute("onclick", "setParentText("+map.client_no+",'"+map.client_name+"','"+map.client_registeredno+"','"+map.client_manager+"')");
