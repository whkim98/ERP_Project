...
function setParentText(h, no, code, barcode, name, ctotal, unit, size, cname1, cname2, sname, kname){
	...
	opener.document.getElementById("blist1["+h+"].goods_no2").value = no;
	opener.document.getElementById("crlist1["+h+"].goodssort_name").value = sname + " - " + kname;
	opener.document.getElementById("crlist1["+h+"].goodslot_total").value = ctotal;
	...
	opener.document.getElementById("blist1["+h+"].bom_require").value = '';
	opener.document.getElementById("blist1["+h+"].bom_obtain").value = '';
	opener.document.getElementById("blist1["+h+"].bom_note").value = '';
	window.close();
}
