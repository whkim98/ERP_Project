...
<div>
	...
	<table id="procode">
		...
		<c:forEach var="vo" items="${list }">
				<tr onclick="setParentText(${vo.company_no },'${vo.company_name}','${vo.company_representative}', '${vo.company_addr1 }', '${vo.company_addr2 }', '${vo.company_registeredno }', '${vo.businesstype_name }', '${vo.businesstype_subctgr }', '${vo.company_directno }')">
...
function setParentText(no,name, rep, addr1, addr2, rno, bname, bsub, dno){
	...
	opener.document.getElementById("company_directno").value = dno;
	...
	opener.document.getElementById("businesstype_name2").value = bname;
	opener.document.getElementById("businesstype_subctgr2").value = bsub;
	window.close();
}
