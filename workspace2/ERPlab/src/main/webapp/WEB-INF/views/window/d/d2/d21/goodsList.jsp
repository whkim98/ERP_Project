...
<div>
	...
	<table id="procode">
		...
		<c:forEach var="vo" items="${list }">
				<tr onclick="setParentText('${i}', ${vo.goods_no}, '${vo.goods_code}', '${vo.goods_barcode }', '${vo.goods_name }', '${vo.goodsst_unit }', '${vo.goodsst_size }', ${vo.goodsst_ea }, '${vo.client_name1 }', '${vo.client_name2 }', '${vo.goodssort_name }', '${vo.goodskind_name }')">
...
<script type="text/javascript">
	function setParentText(h, no, code, barcode, name, unit, size, ea, cname1, cname2, sname, kname){
    	opener.document.getElementById("crlist1["+h+"].goods_code").value = code;
    	opener.document.getElementById("oclist1["+h+"].goods_no").value = no;
    	...
    	opener.document.getElementById("oclist1["+h+"].orderconnect_qty").value = '';
    	opener.document.getElementById("oclist1["+h+"].orderconnect_price").value = '';
    	opener.document.getElementById("oclist1["+h+"].orderconnect_tax").value = '';
    	opener.document.getElementById("oclist1["+h+"].orderconnect_total").value = '';
    	window.close();
    }
	...
	function bnajax(v, code, cname){
		...
		var url = "${pageContext.request.contextPath}/d/d2/d21/goodsListAjax";
		...
		if(xhr.readyState==4 && xhr.status==200) {	
			...
			if(data != "")
				...
				data2.forEach(function(map){
					...
					newTr.setAttribute("onclick", "setParentText('${param.i}',"+map.goods_no+",'"+map.goods_code+"','"+map.goods_barcode+"','"+map.goods_name+"','"+map.goodsst_unit+"','"+map.goodsst_size+"',"+map.goodsst_ea+",'"+map.client_name1+"','"+map.client_name2+"','"+map.goodssort_name+"','"+map.goodskind_name+"')");
