...
<script type="text/javascript">
	function setParentText(h, gno, no, code, barcode, name, unit, size, ea, cname1, cname2, sname, kname){
    	...
    	opener.document.getElementById("plist["+h+"].purchaseconnect_number").value = '';
    	opener.document.getElementById("plist["+h+"].purchaseconnect_price").value = '';
    	opener.document.getElementById("plist["+h+"].purchaseconnect_tax").value = '';
    	opener.document.getElementById("plist["+h+"].purchaseconnect_total").value = '';
    	window.close();
    }
