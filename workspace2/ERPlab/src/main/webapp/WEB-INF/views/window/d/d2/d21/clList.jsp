...
<div>
	...
	<table id="procode">
		...
		<c:forEach var="vo" items="${list }">
				<tr onclick="setParentText(${vo.client_no }, '${vo.client_name}', '${vo.client_registeredno }', '${vo.client_representative }', '${vo.client_directno }', '${vo.businesstype_name }', '${vo.businesstype_subctgr }', '${vo.client_addr1 }', '${vo.client_addr2 }')">
...
<script type="text/javascript">
	function setParentText(no, name, register, representative, directno, bname, subctgr, addr1, addr2){
    	...
    	opener.document.getElementById("businesstype_name1").value = bname;
    	opener.document.getElementById("businesstype_subctgr1").value = subctgr;
    	opener.document.getElementById("client_addr1").value = addr1;
    	opener.document.getElementById("client_addr2").value = addr2;
    	window.close();
    }
		...
		if(xhr.readyState==4 && xhr.status==200) {	
			...
			if(data != ""){
				...
				data2.forEach(function(map){
					...
					newTr.setAttribute("onclick", "setParentText("+map.client_no+",'"+map.client_name+"','"+map.client_registeredno+"','"+map.client_representative+"','"+map.client_directno+"','"+map.businesstype_name+"','"+map.businesstype_subctgr+"','"+map.client_addr1+"','"+map.client_addr2+"')");
