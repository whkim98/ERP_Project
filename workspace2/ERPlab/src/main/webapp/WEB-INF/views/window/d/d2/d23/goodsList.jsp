...
<script type="text/javascript">
	function setParentText(h, no, code, barcode, name, unit, size, ea, cname1, cname2, sname, kname, price){
    	...
    	opener.document.getElementById("crlist1["+h+"].goodslot_price").value = price;
		...
		if(xhr.readyState==4 && xhr.status==200) {	
			...
			if(data != "")
				...
				data2.forEach(function(map){
					...
					newTr.setAttribute("onclick", "setParentText('${param.i}',"+map.goodslot_no+",'"+map.goods_code+"','"+map.goods_barcode+"','"+map.goods_name+"','"+map.goodsst_unit+"','"+map.goodsst_size+"',"+map.goodsst_ea+",'"+map.client_name1+"','"+map.client_name2+"','"+map.goodssort_name+"','"+map.goodskind_name+"',"+map.goodslot_price+")");
