...
<div>
	...
	<table id="procode">
		...
		<c:forEach var="vo" items="${list }">
				<tr onclick="setParentText('${i}', ${vo.goodslot_no}, '${vo.goods_code}', '${vo.goods_barcode }', '${vo.goods_name }', '${vo.goodsst_unit }', '${vo.goodsst_size }', ${vo.goodslot_qty }, '${vo.client_name1 }', '${vo.client_name2 }', '${vo.goodssort_name }', '${vo.goodskind_name }', ${vo.goodslot_total })">
...
<script type="text/javascript">
	function setParentText(h, no, code, barcode, name, unit, size, ea, cname1, cname2, sname, kname, total){
    	opener.document.getElementById("crlist1["+h+"].goods_code").value = code;
    	opener.document.getElementById("iclist1["+h+"].goodslot_no").value = no;
    	opener.document.getElementById("crlist1["+h+"].goodslot_total").value = total;
    	...
    	opener.document.getElementById("crlist1["+h+"].goodslot_qty").value = ea;
    	...
    	opener.document.getElementById("iclist1["+h+"].invenconnect_qty").value = '';
    	opener.document.getElementById("iclist1["+h+"].invenconnect_availableqty").value = '';
    	opener.document.getElementById("iclist1["+h+"].invenconnect_date").value = '';
    	window.close();
    }
	...
	function bnajax(v, code){
		...
		var url = "${pageContext.request.contextPath}/d/d2/d23/goodsListAjax";
		...
		if(xhr.readyState==4 && xhr.status==200) {	
			...
			if(data != "")
				...
				data2.forEach(function(map){
					...
					newTr.setAttribute("onclick", "setParentText('${param.i}',"+map.goodslot_no+",'"+map.goods_code+"','"+map.goods_barcode+"','"+map.goods_name+"','"+map.goodsst_unit+"','"+map.goodsst_size+"',"+map.goodsst_ea+",'"+map.client_name1+"','"+map.client_name2+"','"+map.goodssort_name+"','"+map.goodskind_name+"',"+map.goodslot_total+")");
