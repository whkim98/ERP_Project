...
public class D2Controller {
	...
	public D2Controller(D2Service d2, HttpServletRequest request, LoginService ls, D1Service d1, C2Service c2, A3Service a3) {
		this.d2 = d2;
...
//	Order
	...
	public String inputOrder(String comcode_code, String type, String word, Model model) {
		...
		return ViewPath.D2 + "/d21/inputOrder";
	}
	
	@RequestMapping("/d21/inputOrderAjax")
	@ResponseBody
	...
	public String updateFormO(Erp_OrderVO ovo, Model model) {
		...
		return ViewPath.D2 + "/d21/selectForm";
	}
	
	@RequestMapping("/d21/addForm")
	...
	@RequestMapping("/d21/createOrder")
	@Transactional
	public String createOrder(Erp_OrderVO vo, String comcode_code, Erp_OrderconnectVO ovo, Model model, 
		...
		return "redirect:/d/d2/d21/updateForm?order_no="+ono+"&order_code="+vo.getOrder_code();
	}
	
	@RequestMapping("/d21/update")
	@Transactional
	public String updateOrder(Erp_OrderVO vo, Erp_OrderconnectVO ovo, Model model, 
		...
		return "redirect:/d/d2/d21/updateForm?order_no="+vo.getOrder_no()+"&order_code="+vo.getOrder_code();
	}
	
	@RequestMapping("/d21/delete")
	@Transactional
	public String deleteOrder(Erp_OrderVO vo, String comcode_code, Model model, String bs3_no1, String bs3_no2) {
		...
		return "redirect:/d/d2/d21/inputOrder?comcode_code="+comcode_code;
	}
	
	@RequestMapping("/d21/deleteGoods")
	@ResponseBody
	...
	@RequestMapping("/d21/goodsListAjax")
	@ResponseBody
	...
	@RequestMapping(value="/d21/getOrderCode", produces = "application/text;charset=utf8")
	@ResponseBody
...
//	Purchase
	@RequestMapping("/d22/inputPurchase")
	public String inputPurchase(String comcode_code, String type, String word, Model model) {
		...
		return ViewPath.D2 + "/d22/inputPurchase";
	}
	
	@RequestMapping("/d22/inputPurchaseAjax")
	@ResponseBody
	...
	public String updateFormPC(Erp_PurchaseVO vo, Model model) {
		...
		return ViewPath.D2 + "/d22/selectForm";
	}
	
	@RequestMapping("/d22/addForm")
	...
	@RequestMapping("/d22/createPurchase")
	@Transactional
	public String createPurchase(Erp_PurchaseVO vo, Erp_PurchaseconnectVO pvo, String comcode_code, Model model, 
		...
		return "redirect:/d/d2/d22/updateForm?purchase_no="+pno+"&purchase_code="+vo.getPurchase_code();
	}
	
	@RequestMapping("/d22/update")
	@Transactional
	public String updatePurchase(String debtor_no, String creditor_no, String bs3_no11, String bs3_no21, String bs3_no12, String bs3_no22, 
		...
		return "redirect:/d/d2/d22/updateForm?purchase_no="+vo.getPurchase_no()+"&purchase_code="+vo.getPurchase_code();
	}
	
	@RequestMapping("/d22/delete")
	@Transactional
	public String deletePurchase(Erp_PurchaseVO vo, String comcode_code, Model model, String bs3_no1, String bs3_no2) {
		...
		return "redirect:/d/d2/d22/inputPurchase?comcode_code="+comcode_code;
	}
	
	@RequestMapping("/d22/deleteGoods")
	@Transactional
	@ResponseBody
	...
	@RequestMapping("/d22/goodsListAjax")
	@ResponseBody
...
//	producttest
	@RequestMapping("/d24/inputProductTest")
	public String inputProductTest(String comcode_code, String type, String word, Model model) {
		...
		return ViewPath.D2 + "/d24/inputProductTest";
	}
	
	@RequestMapping("/d24/updateForm")
	...
	@RequestMapping("/d24/inputProductTestAjax")
	@ResponseBody
	...
	@RequestMapping("/d24/createProductTest")
	@Transactional
	public String createProductTest(Erp_ProducttestVO vo, String comcode_code, Model model) {
		...
		return "redirect:/d/d2/d24/inputProductTest?comcode_code="+comcode_code;
	}
	
	@RequestMapping("/d24/update")
	@Transactional
	public String updateProductTest(Erp_ProducttestVO vo, String comcode_code, Model model) {
		...
		return "redirect:/d/d2/d24/updateForm?comcode_code="+comcode_code+"&producttest_no="+vo.getProducttest_no();
	}
	
	@RequestMapping("/d24/delete")
	@Transactional
...
//	inventory
	@RequestMapping("/d23/inputInventory")
	public String inputInventory(String comcode_code, String type, String word, Model model) {
		...
		return ViewPath.D2 + "/d23/inputInventory";
	}
	
	@RequestMapping("/d23/inputInventoryAjax")
	@ResponseBody
	...
	@RequestMapping("/d23/addInventory")
	public String addInventory(String comcode_code, Model model) {
		...
		return ViewPath.D2 + "/d23/selectForm";
	}
	
	@RequestMapping("/d23/updateForm")
	...
	@RequestMapping("/d23/createInventory")
	@Transactional
	...
	@RequestMapping("/d23/deleteGoods")
	@ResponseBody
	...
	@RequestMapping("/d23/goodsListAjax")
	@ResponseBody
